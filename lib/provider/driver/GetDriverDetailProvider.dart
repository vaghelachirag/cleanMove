import 'dart:convert';
import 'package:shaligram_transport_app/models/driver/profile/GetDriverDetailResponse.dart';
...
class  GetDriverDetailProvider extends BaseProvider {

  // Get Driver  Detail
  Future<Result<GetDriverDetailResponse>> getDriverDetailResponse() async {
    try {
      var handleRes =  await apiService.get(ApiEndPoints.getDriverDetail);
      ...
      if (handleRes.statusCode == 200) {
        if (handleRes.body != null) {
          if(handleRes.body["Data"] != null){
            ...
            var userModel =   GetDriverDetailResponse.fromJson(result);
