import 'dart:convert';
import 'package:shaligram_transport_app/models/driver/vehicle/GetDriverRouteResponseModel.dart';
import '../../../api/repository/api_end_points.dart';
import '../../../api/repository/base_provider.dart';
import '../../../models/api_status.dart';
import '../../../widget/common_widget.dart';

class  GetDriverRouteProvider extends BaseProvider {


// Get Driver Route Response
  Future<Result<GetRouteResponseModel>> getDriverRouteResponse(String driverId,String vehicleId) async {

    try {
      var handleRes =  await apiService.get("${ApiEndPoints.getDriverRoute}?vehicleId=$vehicleId");
      ...
      if (handleRes.statusCode == 200) {
        if (handleRes.body != null) {
          if(handleRes.body["Data"] != null){
            ...
            var userModel =   GetRouteResponseModel.fromJson(result);
