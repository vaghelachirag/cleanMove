...
class  GetLogoutProvider extends BaseProvider {

  // Get Logout Response
  Future<Result<GetLogoutResponse>> getLogoutResponse(String userId,String roleId) async {

    try {
      var handleRes =  await apiService.post("${ApiEndPoints.logOut}?userId=$userId&roleid=$roleId", null);
      ...
      if (handleRes.statusCode == 200) {
        if (handleRes.body != null) {
          if(handleRes.body != null){
            ...
            var userModel =   GetLogoutResponse.fromJson(result);
