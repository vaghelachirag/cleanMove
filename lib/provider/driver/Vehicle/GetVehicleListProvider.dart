...
class  GetVehicleListProvider extends BaseProvider {

// Get Vehicle List Response for Driver
  Future<Result<GetVehicleListResponse>> getVehicleListApiResponse() async {
    try {
      var handleRes =  await apiService.get(ApiEndPoints.getVehicleList);
      ...
      if (handleRes.statusCode == 200) {
        if (handleRes.body != null) {
          if(handleRes.body["Data"] != null){
            ...
            var userModel =   GetVehicleListResponse.fromJson(result);
